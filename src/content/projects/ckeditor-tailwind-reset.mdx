...
excerpt: Package for rewriting TailwindCSS style in CKEditor Component
category: Library
# link: https://tereby.netlify.app
repository: https://github.com/RSurya99/ckeditor-tailwind-reset
tags:
  - Javascript
  - CSS
author:
...
CKEditor Tailwind Reset is a package that I made in late 2021 and has 2800+ downloads. The reason why I made this package is that if you use TailwindCSS alongside CKEditor, the CKEditor WYSIWYG will not work because CKEditor is using default browser typography, meanwhile, TailwindCSS reset it with the preflight plugin.

This package is used to fix that thing, but now it is deprecated because TailwindCSS already made their new plugin @tailwindcss/typography.
