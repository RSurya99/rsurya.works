...
Gosumemory is a program that can do live tracking to see my activities in osu!, it can also show real-time pp counter and real-time statistics of my play. Gosumemory is written in GO, basically it doesn't have WebSocket support for another app, so I need to make a WebSocket server to connect to Gosumemory.
...
- [x] Create Osu! and General Scene potrait version
