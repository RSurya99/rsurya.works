    ...
    <div className="space-y-12">
      ...
      <section className='w-full max-w-screen-xl mx-auto grid grid-cols-2 py-12'>
        <div className="flex flex-col justify-center">
          ...
          <div>
            <button className="px-12 py-4 bg-primary dark:bg-white hover:bg-zinc-700 hover:dark:bg-zinc-200 text-white dark:text-primary font-medium rounded-lg transition-colors duration-300">Contact Me</button>
          </div>
        </div>
