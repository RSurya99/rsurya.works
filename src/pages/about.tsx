  ...
  return (
    <section className='w-full max-w-screen-xl mx-auto py-12 space-y-8'>
      <div className='max-w-5xl space-y-6'>
        ...
        <p className="text-lg tracking-wide leading-relaxed text-primary-300 dark:text-zinc-200">Hi there! my name is Rafli Surya Pratama, and I am a Front End Engineer.</p>
      ...
      <div className="max-w-5xl space-y-6">
        ...
        <div className="space-y-3">
          ...
          <p className="text-lg tracking-wide leading-relaxed text-primary-300 dark:text-zinc-200">Javascript, Typescript, PHP, Python</p>
        </div>
        <div className="space-y-3">
          <h3 className="text-3xl font-semibold leading-tight">Markup Language</h3>
          <p className="text-lg tracking-wide leading-relaxed text-primary-300 dark:text-zinc-200">HTML, Markdown</p>
        </div>
        <div className="space-y-3">
          <h3 className="text-3xl font-semibold leading-tight">Framework</h3>
          <p className="text-lg tracking-wide leading-relaxed text-primary-300 dark:text-zinc-200">JQuery, Vue (and Nuxt), React (and Next), Express.js, Laravel, Django </p>
        </div>
        <div className="space-y-3">
          <h3 className="text-3xl font-semibold leading-tight">Styling</h3>
          <p className="text-lg tracking-wide leading-relaxed text-primary-300 dark:text-zinc-200">SASS/SCSS, Tailwind CSS, Bootstrap, Vuetify, Ant Design, Material UI, Mantine, Element UI, Uno CSS</p>
        </div>
        <div className="space-y-3">
          <h3 className="text-3xl font-semibold leading-tight">Build tools</h3>
          <p className="text-lg tracking-wide leading-relaxed text-primary-300 dark:text-zinc-200">Webpack, Rollup, Vite</p>
        </div>
        <div className="space-y-3">
          <h3 className="text-3xl font-semibold leading-tight">Others</h3>
          <p className="text-lg tracking-wide leading-relaxed text-primary-300 dark:text-zinc-200">Git, Linux, SQL, MongoDB, Firebase, Docker, Figma, Storybook</p>
        </div>
      </div>
    </section>
  )
